            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="/jathow/emp/getEmpList?pageNo=1">首页</a></li>
                            <c:if test="${curPage==1}">
                                <li class="disabled">
                            ...
                            <c:forEach begin="1" end="${totalPages<5?totalPages:5}" step="1" var="itemPage">
                                <c:if test="${curPage == itemPage}">
                                    <li class="active"><a href="/jathow/emp/getEmpList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                                <c:if test="${curPage != itemPage}">
                                    <li><a href="/jathow/emp/getEmpList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <li><a href="/jathow/emp/getEmpList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
...
<script>
    $(function () {
        ...
        $(".prePage").click(function () {
            if (curPage > 1){
                ...
                $(this).attr("href", "/jathow/emp/getEmpList?pageNo="+pageNo);
            }
        });
        //下一页
    ...
    $(".emp_delete_btn").click(function () {
        ...
        if (confirm("确认删除【" + delEmpName+ "】的信息吗？")){
            $.ajax({
                url:"/jathow/emp/deleteEmp/"+delEmpId,
                type:"DELETE",
                success:function (result) {
                    if (result.code == 100){
                        alert("删除成功！");
                        window.location.href="/jathow/emp/getEmpList?pageNo="+curPage;
                    }else {
