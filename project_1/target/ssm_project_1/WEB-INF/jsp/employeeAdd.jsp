        ...
        $.ajax({
            ...
            success:function (result) {
                if (result.code == 100){
                    ...
                    $.ajax({
                        url:"/jathow/emp/getTotalPages",
                        type:"GET",
                        success:function (result) {
                            var totalPage = result.extendInfo.totalPages;
                            window.location.href="/jathow/emp/getEmpList?pageNo="+totalPage;
                        }
                    })
                } else {
                    alert("员工新增失败！");
