...
<div class="panel-group col-sm-2" id="jathow_sidebar_left" role="tablist" aria-multiselectable="true">
...
</div><!-- /.panel-group，#jathow_sidebar_left -->

<script type="text/javascript">
    //跳转到员工页面
    $(".emp_info").click(function () {
        $(this).attr("href", "/jathow/emp/getEmpList");
    });
    //跳转到部门页面
    $(".dept_info").click(function () {
        $(this).attr("href", "/jathow/dept/getDeptList");
    });
    //员工清零这个功能暂未实现
