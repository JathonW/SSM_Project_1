...
<body>
<div class="jathow_brand_nav">
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#jathow-navbar-collapse-1" aria-expanded="false">
            ...
            <div class="collapse navbar-collapse" id="jathow-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            ...
                            <li><a href="#" class="jathow_logout"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> 账号退出</a></li>
                        </ul>
                    </li>
...
</div><!-- /.jathow_brand_nav -->
<script type="text/javascript">
    //主页面
    $("#company_logo").click(function () {
        $(this).attr("href", "/jathow/main");
    });
    //账号退出
    $(".jathow_logout").click(function () {
        window.location.href = "/jathow/logout";
    });
</script>
</body>
</html>
